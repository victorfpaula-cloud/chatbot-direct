...
export async function PainelDeReservas({
  ...
  return (
    ...
    <main className="relative mx-auto max-w-3xl px-3 py-10 sm:px-6 md:max-w-4xl">
      ...
      {/* [backdrop-filter]/[-webkit-backdrop-filter] em vez de backdrop-blur-lg: mesmo blur (16px),
